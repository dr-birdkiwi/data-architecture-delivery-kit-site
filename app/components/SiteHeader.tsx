  ...
  return (
    <header className="site-header landing-header">
      <a className="brand" href="/data-architecture-delivery-kit-site/" aria-label="Data Architecture Delivery Kit home">
        ...
        <span>Data Architecture Delivery Kit</span>
      </a>
      <nav aria-label="Primary navigation">
        ...
        <a className="nav-cta" href="https://github.com/dr-birdkiwi/data-architecture-delivery-kit-site" target="_blank" rel="noreferrer">
          View site source ↗
        </a>
      </nav>
    </header>
